...
export const apps = [
  // ── GRUPO 1: icono I1 — versiones 1.0.0 → 3.0.0 ─────────────────────────
  ...
  // ── GRUPO 2: icono I312 — versiones 3.1.0 → 3.1.2 ───────────────────────
  mk(30, '3.1.0', '26 MB', I312), 'https://archive.org/download/angry_birds_classic_ios_ports_preservation_pack/APPS/Normal/Normal.zip/Angry%20Birds%20iPhone%20%283.1.0%29.apk'),
  mk(31, '3.1.2', '26 MB', I312), 'https://archive.org/download/angry_birds_classic_ios_ports_preservation_pack/APPS/Normal/Normal.zip/Angry%20Birds%20iPhone%20%283.1.2%29.apk'),

  // ── GRUPO 3: icono I32 — versiones 3.2.0 → 6.0.1 ────────────────────────
  mk(32, '3.2.0', '27 MB', I32), 'https://archive.org/download/angry_birds_classic_ios_ports_preservation_pack/APPS/Normal/Normal.zip/Angry%20Birds%20iPhone%20%283.2.0%29.apk'),
  mk(33, '3.3.0', '28 MB', I32), 'https://archive.org/download/angry_birds_classic_ios_ports_preservation_pack/APPS/Normal/Normal.zip/Angry%20Birds%20iPhone%20%283.3.0%29.apk'),
  mk(34, '3.3.1', '28 MB', I32), 'https://archive.org/download/angry_birds_classic_ios_ports_preservation_pack/APPS/Normal/Normal.zip/Angry%20Birds%20iPhone%20%283.3.1%29.apk'),
  mk(35, '3.4.0', '29 MB', I32), 'https://archive.org/download/angry_birds_classic_ios_ports_preservation_pack/APPS/Normal/Normal.zip/Angry%20Birds%20iPhone%20%283.4.0%29.apk'),
  mk(36, '3.4.1', '29 MB', I32), 'https://archive.org/download/angry_birds_classic_ios_ports_preservation_pack/APPS/Normal/Normal.zip/Angry%20Birds%20iPhone%20%283.4.1%29.apk'),
  mk(37, '4.0.0', '32 MB', I32), 'https://archive.org/download/angry_birds_classic_ios_ports_preservation_pack/APPS/Normal/Normal.zip/Angry%20Birds%20iPhone%20%284.0.0%29.apk'),
  mk(38, '4.3.2', '35 MB', I32), 'https://archive.org/download/angry_birds_classic_ios_ports_preservation_pack/APPS/Normal/Normal.zip/Angry%20Birds%20iPhone%20%284.3.2%29.apk'),
  mk(39, '4.3.5', '35 MB', I32), 'https://archive.org/download/angry_birds_classic_ios_ports_preservation_pack/APPS/Normal/Normal.zip/Angry%20Birds%20iPhone%20%284.3.5%29.apk'),
  mk(40, '5.0.1', '38 MB', I32), 'https://archive.org/download/angry_birds_classic_ios_ports_preservation_pack/APPS/Normal/Normal.zip/Angry%20Birds%20iPhone%20%285.0.1%29.apk'),
  mk(41, '5.1.0', '39 MB', I32), 'https://archive.org/download/angry_birds_classic_ios_ports_preservation_pack/APPS/Normal/Normal.zip/Angry%20Birds%20iPhone%20%285.1.0%29.apk'),
  mk(42, '5.2.0', '40 MB', I32), 'https://archive.org/download/angry_birds_classic_ios_ports_preservation_pack/APPS/Normal/Normal.zip/Angry%20Birds%20iPhone%20%285.2.0%29.apk'),
  mk(43, '6.0.1', '43 MB', I32), 'https://archive.org/download/angry_birds_classic_ios_ports_preservation_pack/APPS/Normal/Normal.zip/Angry%20Birds%20iPhone%20%286.0.1%29.apk'),

  // ── GRUPO 4: icono I606 — versión 6.0.6 ──────────────────────────────────
  mk(44, '6.0.6', '44 MB', I606),

  // ── GRUPO 5: icono I61 — versiones 6.1.0 → 6.2.1 ────────────────────────
  mk(45, '6.1.0', '45 MB', I61),
  mk(46, '6.1.1', '45 MB', I61),
  mk(47, '6.2.1', '46 MB', I61),

  // ── GRUPO 6: icono I32 — versiones 6.1.5 → 8.0.3 ────────────────────────
  ...
  // ── Tarjetas vacías (para apps futuras) ───────────────────────────────────
