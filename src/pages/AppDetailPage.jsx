                ...
                ? <img
                    ...
                    onError={e => {
                      if (!e.target.dataset.retry) {
                        ...
                        e.target.src = `https://corsproxy.io/?${encodeURIComponent(app.iconUrl)}`;
                      } else if (e.target.dataset.retry === '1') {
                        e.target.dataset.retry = '2';
                        e.target.src = `https://api.allorigins.win/raw?url=${encodeURIComponent(app.iconUrl)}`;
                      }
                    }}
                  />
                : app.icon
